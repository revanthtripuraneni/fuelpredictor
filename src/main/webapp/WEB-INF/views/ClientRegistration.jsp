		...
		<div class="container-login100" style="background-image: url('css/images/Bk3.jfif');">
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method="post" action="registration.do">
					...
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						...
						<input class="input100" id = "password" type="password" name="pass" placeholder="Enter a Password" required>
						<span class="focus-input100" data-symbol="&#x1F511;"></span>
					</div>
					<br>
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						<span class="label-input100">Confirm Password<span style="color:red">*</span>	</span>
						<input class="input100" id = "cpassword" type="password" name="cpass" placeholder="Re-Enter Password" required>
						<span class="focus-input100" data-symbol="&#x1F511;"></span>
					</div>
          ...
          <br><br>
					...
					<div class="container-login100-form-btn">
						<p><font color = "red">${error}</font><br></p>
